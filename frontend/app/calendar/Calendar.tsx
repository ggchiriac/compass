...
//   const events: CalendarEvent[] = selectedCourses.flatMap((event) => {
//     const sectionEvents: CalendarEvent[] = event.section.flatMap((section) => {
//       return section.class_meetings.map((classMeeting) => {
//         const startTime = classMeeting.start_time;
//         const endTime = classMeeting.end_time;
//         const startRowIndex = calculateGridRow(startTime);
//         const endRowIndex = calculateGridRow(endTime);

//         return {
//           key: `${event.course.id}-${section.id}-${classMeeting.id}`,
//           event,
//           section,
//           classMeeting,
//           startTime,
//           endTime,
//           startColumnIndex: getStartColumnIndexForDays(classMeeting.meeting_days)[0],
//           startRowIndex,
//           endRowIndex,
//         };
//       });
...
//   // FIXME pls change this const name vv
...
//     console.log('Clicked Section:', event.course.id);
//   };
