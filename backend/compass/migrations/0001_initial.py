# Generated by Django 5.0.6 on 2024-08-24 07:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('term_code', models.CharField(db_index=True, max_length=10, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course_guid', models.CharField(db_index=True, max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(db_index=True, max_length=4, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('emplid', models.CharField(db_index=True, max_length=50, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('net_id', models.CharField(blank=True, max_length=20, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_id', models.CharField(db_index=True, max_length=15, null=True)),
                ('catalog_number', models.CharField(db_index=True, max_length=10, null=True)),
                ('title', models.CharField(db_index=True, max_length=150, null=True)),
                ('crosslistings', models.CharField(db_index=True, max_length=150, null=True)),
                ('description', models.TextField(db_index=True, null=True)),
                ('drop_consent', models.CharField(blank=True, db_index=True, max_length=1, null=True)),
                ('add_consent', models.CharField(blank=True, db_index=True, max_length=1, null=True)),
                ('web_address', models.URLField(blank=True, db_index=True, max_length=255, null=True)),
                ('transcript_title', models.CharField(blank=True, max_length=150, null=True)),
                ('long_title', models.CharField(blank=True, db_index=True, max_length=250, null=True)),
                ('distribution_area_long', models.CharField(blank=True, db_index=True, max_length=150, null=True)),
                ('distribution_area_short', models.CharField(blank=True, db_index=True, max_length=10, null=True)),
                ('reading_writing_assignment', models.TextField(blank=True, db_index=True, null=True)),
                ('grading_basis', models.CharField(blank=True, db_index=True, max_length=5, null=True)),
                ('reading_list', models.TextField(blank=True, db_index=True, null=True)),
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compass.department')),
            ],
            options={
                'db_table': 'Course',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificate', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='req_list', to='compass.certificate')),
                ('course_list', models.ManyToManyField(db_index=True, related_name='satisfied_by', to='compass.course')),
                ('degree', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='req_list', to='compass.degree')),
                ('excluded_course_list', models.ManyToManyField(related_name='not_satisfied_by', to='compass.course')),
                ('major', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='req_list', to='compass.major')),
                ('minor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='req_list', to='compass.minor')),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='req_list', to='compass.requirement')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_type', models.CharField(choices=[('Seminar', 'Seminar'), ('Lecture', 'Lecture'), ('Precept', 'Precept'), ('Unknown', 'Unknown'), ('Class', 'Class'), ('Studio', 'Studio'), ('Drill', 'Drill'), ('Lab', 'Lab'), ('Ear training', 'Ear training')], db_index=True, default='', max_length=50)),
                ('class_section', models.CharField(db_index=True, max_length=10, null=True)),
                ('track', models.CharField(db_index=True, max_length=5, null=True)),
                ('seat_reservations', models.CharField(db_index=True, max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('building_name', models.CharField(db_index=True, max_length=255, null=True)),
                ('section', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compass.section')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('calendar_configuration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='semester_configurations', to='compass.calendarconfiguration')),
                ('term', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='semester_configurations', to='compass.academicterm')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('semester', models.IntegerField(choices=[(1, 'freshman fall'), (2, 'freshman spring'), (3, 'sophomore fall'), (4, 'sophomore spring'), (5, 'junior fall'), (6, 'junior spring'), (7, 'senior fall'), (8, 'senior spring')], db_index=True, null=True)),
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compass.course')),
                ('requirement', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compass.requirement')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester_configuration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schedule_selections', to='compass.semesterconfiguration')),
            ],
            options={
