...
urlpatterns = [
    ...
    path('mark_satisfied/', views.mark_satisfied, name='mark_satisfied'),
    ...
    # Calendar
    path('fetch_calendar_classes/', views.FetchCalendarClasses.as_view(), name='fetch_calendar_classes'),
]
